...
export class PushListener {
  ...
  constructor(options: PushListenerOptions = {}) {
    ...
    this._handleNotificationClick =
      options.handleNotificationClick || this.handleNotificationClick
    this._handleNotificationClose =
      options.handleNotificationClose || this.handleNotificationClose
    this._handleNotificationError =
      options.handleNotificationError || this.handleNotificationError
  ...
  registerListeners() {
    ...
    self.addEventListener(
      'notificationclose',
      this._handleNotificationClose.bind(this)
    )
    self.addEventListener(
      'notificationerror',
   ...
   */
  async isClientFocused(): Promise<boolean> {
